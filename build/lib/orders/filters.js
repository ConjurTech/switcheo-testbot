...
const filterOpenOrders = exports.filterOpenOrders = orders => orders.filter(o => o.status === 'processed' && o.makes.length && !new _bignumber.BigNumber(o.makes.find(m => m.status !== 'expired').availableAmount).eq(0));
